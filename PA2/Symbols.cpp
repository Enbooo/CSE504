...
{
	enterScope();
	createIdentifier("@@function")->setType(Type::Function);
	createIdentifier("@@variable")->setType(Type::Int);
	createIdentifier("printf")->setType(Type::Function);
}
...
{
	mSymbols.insert(std::make_pair(ident->getName(), ident));
}
